    ...
    admin: {
        ...
        products: {
            ...
            form: {
                ...
                availableUntil: 'Hide from the store after',
                availableUntilHint:
                    'Optional. At this time the product switches itself off, for offers that only run during a campaign. Leave empty to keep it on sale.',
        ...
        storeEvents: {
            ...
            offer: {
                ...
                stock: 'Stock: {{n}}',
                leavesAt: 'Leaves the store {{date}}',
            },
            createOffer: {
                open: 'Create a new offer product',
                title: 'New offer product',
                hint: 'For products that exist only for this campaign, such as a bundle. It goes into Special Offers and leaves the store on its own when the event ends ({{date}}).',
                nameAr: 'Name (Arabic)',
                nameEn: 'Name (English)',
                descriptionAr: 'What’s included (Arabic)',
                descriptionEn: 'What’s included (English)',
                price: 'Price (SAR)',
                stock: 'Stock',
                image: 'Photo',
                imageHint: 'Square works best: product photos show as squares on the store.',
                submit: 'Create offer',
                cancel: 'Cancel',
            },
            banners: {
                title: 'Homepage hero banners',
                hint: 'While any of these is live, the homepage hero shows only these banners, in this order. They follow the event’s dates unless you give one its own.',
                empty: 'No hero banners yet.',
                add: 'Add a hero banner',
                addSubmit: 'Add banner',
                desktop: 'Desktop image',
                desktopHint: '1920 × 960 (2:1). Keep text clear of the edges.',
                mobile: 'Phone image (optional)',
                mobileHint: '1080 × 1350 (4:5). Phones only use phone images when every banner has one; otherwise they show the desktop image.',
                noMobile: 'No phone image',
                link: 'Opens',
                linkEvent: 'The event’s own page',
                altAr: 'Description for screen readers (Arabic)',
                altEn: 'Description for screen readers (English)',
                altHint: 'Optional. Defaults to the linked offer’s name.',
                startsAt: 'Own start (optional)',
                endsAt: 'Own end (optional)',
                windowHint: 'Leave empty to follow the event. A banner never runs outside its event.',
